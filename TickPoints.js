function TickPoints(geoJSON, tickLen) {
...
TickPoints.prototype.getFirstTick = function() {
  if (this.firstTick)
...
TickPoints.prototype.getLastTick = function() {
  if (this.lastTick)
...
TickPoints.prototype.getTickMultiPoint = function() {
